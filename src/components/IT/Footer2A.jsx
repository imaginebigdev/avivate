          ...
          <div className="col-lg-6" style={{ textAlign: "center" }}>
            <div className="foot_links text-uppercase text-center small">
              ...
              <Link to="modulo1" smooth="true" duration={100}>
                <span className="mx-4">Etapa 1</span>
              </Link>
              <Link to="modulo2" smooth="true" duration={100}>
                <span className="mx-4">Etapa 2</span>
              </Link>
              <Link to="modulo3" smooth="true" duration={100}>
                <span className="mx-4">Etapa 3</span>
              </Link>
              <Link to="modulo4" smooth="true" duration={100}>
                <span className="mx-4">Etapa 4</span>
              </Link>
            </div>
          </div>
