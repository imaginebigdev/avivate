      ...
      <div className="container">
        <div className="section-head text-center mb-60 style-5">
          <h2 className="mb-20">
            ...
            <span>{rtl ? "واضغط بدأ" : "Kick-start"}</span>
          </h2>
          <p>
            {rtl
              ? "سواء كنت قد بدأت للتو باختبار سريع أو توسيع نطاق المؤسسة ، فقد قمنا بتغطيتك."
                ...
                >
                  ...
                  <h2
                    className={`monthly_price ${
                      plan.bestChoice && "color-blue5"
                    }`}
                  >
                    {plan.price.monthly} <span>/{rtl ? "شهريا" : "mo"}</span>
                  </h2>
                  <h2
                    className={`yearly_price ${
                      plan.bestChoice && "color-blue5"
                    }`}
                  >
                    {plan.price.yearly} <span>/{rtl ? "سنويا" : "yr"}</span>
                  </h2>
