          ...
          <div className="col-lg-5">
            <div className="info">
              <div className="section-head style-8 mb-40">
                ...
                <h3 className="wow fadeInUp"> ¿De qué trata? </h3>
              </div>
              <p className="color-666 wow fadeInUp">
                ...
                curso está diseñado para proporcionarte una base sólida en
                programación y arquitectura de aplicaciones web, así como en las
                tecnologías clave utilizadas en el desarrollo full-stack{" "}
              </p>
              {/* <ul className="mt-30">
